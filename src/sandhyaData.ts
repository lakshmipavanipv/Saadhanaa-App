...
export const RULES = [
  {
    id: 'bath',
    title: 'Bath before performing',
    text: 'Take a full shower (snanam) — purifies body and mind. If no full bath possible, do at least face-hand-feet wash.',
  },
  {
    id: 'clothes',
    title: 'Clean cotton clothes',
    text: 'Wear washed (preferably white or saffron) cotton dhoti/sari. Avoid stitched garments where possible during the ritual.',
  },
  {
    id: 'direction',
    title: 'Direction matters',
    text: 'Pratah & Madhyahnika: face East. Sayam: face West. For Gayatri Japa in Sayam: face North.',
  },
  {
    id: 'asana',
    title: 'Use a clean asana',
    text: 'Sit on kusha grass mat, deer skin, or pure cotton/wool cloth. Never sit directly on bare floor.',
  },
  {
    id: 'silence',
    title: 'Maintain silence',
    text: 'Do not speak during the ritual. If interrupted, do achamana again before continuing.',
  },
  {
    id: 'timing',
    title: 'Strict timing',
    text: 'Pratah: before sunrise. Madhyahnika: ±20 mins of solar noon. Sayam: just after sunset until stars appear.',
  },
  {
    id: 'pollution',
    title: 'Pollution (asaucha) days',
    text: 'During death (10/13 days) or birth (10 days) pollution, sandhya is not performed. Resume after purification.',
  },
  {
    id: 'mind',
    title: 'Mental focus',
    text: 'Withdraw mind from worldly affairs. Focus on Surya/Gayatri Devi. Avoid mechanical chanting.',
  },
  {
    id: 'water',
    title: 'Pure water',
    text: 'Use clean (preferably river/well) water. Avoid leftover water. Replenish before each step.',
  },
  {
    id: 'thread',
    title: 'Yajnopavita (sacred thread)',
    text: 'Wear the sacred thread over left shoulder for normal rituals. Cross-shoulder (nivita) for tarpana to ancestors.',
  },
];

export const PREREQUISITES = [
  'Full bath (snanam) or hand-foot-face wash',
  'Wash mouth and rinse 3 times',
  'Wear clean dhoti/sari (preferably white)',
  'Apply pundra/tilak (vibhuti or sandalwood)',
  'Pure water in a small vessel (kindi)',
  'Clean asana (mat) — kusha or cotton',
  'Tulsi/rudraksha mala for Gayatri japa',
  'Sit in a quiet place facing east',
];
